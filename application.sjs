{
	...
	appname:"script_compiler",// unique variable name of this application, omit this for anonymous applications
	idleMinutes:60,// Lifetime of Application variable cache
	//--------- app package properties
		displayName:"MPages Script Compiler",// "pretty" name used in labels and titles
		description:<ejs>

		</ejs>,//short description of application
		author:"Mark Porter", //name of app author
		authorEmail:"mporter@salud.unm.edu",// email of app author
		website:"",//website associated with this app
		version:"1.0", //app version. This should be a dot notation
